            ...
            <nav class="navbar navbar-dark dark-primary-color navbar-expand-lg">
                ...
                <div class="collapse justify-content-end navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item  mr-2">
                            <a class="nav-link rounded activeState" href="bvnLogsGlo.php" data-toggle="tooltip" data-placement="bottom" title="View Bvn GLO Logs"><span>BVN GLO Logs</span> <i class="fas fa-database"></i></a>
                        </li>
                        <li class="nav-item  mr-2">
...
<!--        <div id="loaderContainer" class="loaderContainer d-none">
        ...
        <script type="text/javascript" src="getBvnDataGlo.js"></script>
