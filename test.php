    ...
    $glo_sql = <<<SQL
        ...
        from
            (
                ...
                and to_date(to_char(tstamp, 'yyyy-mm-dd'), 'yyyy-mm-dd') = to_date('2019-05-29','yyyy-mm-dd')
            )
...
SQL;
    ...
    $nia_sql = <<<SQL
        ...
        (    
            ...
            where 
                biller = '11' and
                to_date(to_char(createdon, 'yyyy-mm-dd'), 'yyyy-mm-dd') = to_date('2019-05-30','yyyy-mm-dd')
        )
        group by code,operator,hour,temp   
SQL;

    $hourly_report = addToHourlyResult(addToHourlyResult(array(), getQueryResult($log_sql)), getQueryResult($log_sql));
    return addToHourlyResult($hourly_report, getQueryResult($nia_sql));
}
...
if (isset($_GET['dateRange'])) {
    ...
    $report = getHourlyReport(date("Y-m-d"));
}
krsort($report);
?>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row" style="margin-left : 5%">
                <h6 class="mb-2 d-none text-white p-2 dark-primary-color rounded" id="dateHeader"><?php echo $table_header; ?></h6><br><br>
            </div>
            <div class="row d-flex justify-content-start mx-1 mt-4 px-5">
                ...
                <table id="" class="table mt-2 text-center light-primary-color secondary-text-color table-hover border border-dark rounded table-bordered">
                    <thead>
                        <tr>
