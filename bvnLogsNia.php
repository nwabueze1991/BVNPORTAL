            ...
            <nav class="navbar navbar-dark dark-primary-color navbar-expand-lg">
                ...
                <div class="collapse justify-content-end navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item  mr-2">
                            <a class="nav-link rounded activeState" href="bvnLogsNia.php" data-toggle="tooltip" data-placement="bottom" title="View Bvn Logs for NIA"><span>BVN Logs NIA</span> <i class="fas fa-database"></i></a>
                        </li>
                        <li class="nav-item  mr-2">
...
<!--                        <tbody>
        ...
        <script type="text/javascript" src="getBvnDataNia.js"></script>
